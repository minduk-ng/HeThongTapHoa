...
use App\Http\Controllers\Reports\LowStockReportController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('manager')->middleware(CheckPageAccess::class)->group(function () {
        ...
        Route::post('/promotions/{promotion}/codes/toggle', [PromotionController::class, 'toggleCodes'])->middleware('permission:promotions.edit');
