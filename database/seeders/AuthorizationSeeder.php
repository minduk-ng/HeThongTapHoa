    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            [
                ...
                'route_path' => '/reports/inventory-value',
                'group_name' => 'Báo cáo',
                'sub_group' => 'Kho',
                'sort_order' => 36,
            ],
            [
                'name' => 'Báo cáo nguyên liệu sắp hết',
                'route_path' => '/reports/low-stock',
                'group_name' => 'Báo cáo',
                'sub_group' => 'Kho',
                'sort_order' => 37,
            ],
            [
                'name' => 'Báo cáo nguyên liệu sắp hết hạn',
                'route_path' => '/reports/expiring',
                'group_name' => 'Báo cáo',
                'sub_group' => 'Kho',
                'sort_order' => 38,
            ],
