                ...
                <table className="w-full text-left text-sm">
                    <thead className="bg-zinc-50 dark:bg-zinc-800/60 text-zinc-600 dark:text-zinc-400 font-medium border-b border-zinc-200 dark:border-zinc-800">
                        <tr>
                            ...
                            <th className="py-3 px-4 text-center">Tổng sản phẩm</th>
                            <th className="py-3 px-4 text-right">Tổng đơn giá</th>
                                ...
                                return (
                                    <React.Fragment key={category.id}>
                                        ...
                                        >
                                            ...
                                            <td className="py-3.5 px-4 text-center">
                                                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700">
                                        ...
                                        {isExpanded && (
                                            <tr className="bg-zinc-50/90 dark:bg-zinc-950/60 border-t border-b border-zinc-200 dark:border-zinc-800">
                                                <td colSpan={5} className="py-3 px-6 pl-12">
                                                    <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden bg-white dark:bg-zinc-900 shadow-xs">
                                                        <div className="bg-zinc-100/80 dark:bg-zinc-800/80 px-4 py-2 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">
                                                        ...
                                                        {!hasChildren ? (
                                                            ...
                                                            <table className="w-full text-left text-xs">
                                                                <thead className="bg-zinc-50 dark:bg-zinc-800/40 text-zinc-500 border-b border-zinc-200 dark:border-zinc-800">
                                                                    <tr>
                                                                        <th className="py-2 px-3 w-24">Mã SP</th>
                                                                ...
                                                                <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-zinc-700 dark:text-zinc-300">
                                                                    {category.items!.map((child) => (
                                                                        <tr key={child.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
